...
extension UICollectionView {
    ...
    func movieListSection() -> NSCollectionLayoutSection {
        ...
        let itemPadding = NSDirectionalEdgeInsets(top: 6, leading: 6, bottom: 0, trailing: 6)
        let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1), heightDimension: .fractionalHeight(0.42))
        let groupPadding = NSDirectionalEdgeInsets(top: 6, leading: 6, bottom: 0, trailing: 6)
